...
const questions=[
 ...
 {question:'4주 동안 무엇을 배우나요?',answer:'1주차는 현재 AI와 도구의 기능, 2주차는 PRD와 업무 구조 설계, 3주차는 도전적인 위임과 지속적인 학습, 4주차는 AI 기술과 산업의 구조를 다룹니다. 주 1회, 회당 2시간의 교육이에요.',link:'#curriculum',label:'4주 커리큘럼 보기'},
 ...
 {question:'어떻게 참여할 수 있나요?',answer:'참가 신청에서 시작 가능한 첫 토요일과 참여 가능한 시간대를 모두 알려 주세요. 일정이 맞는 분들과 코호트를 구성한 뒤, 남겨 주신 전화번호로 일정과 참가비를 안내합니다. 안내를 확인한 후 참여가 확정돼요.',link:'/apply',label:'참가 신청하러 가기'},
];
